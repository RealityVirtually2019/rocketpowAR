...
namespace UnityEngine.XR.MagicLeap
{
    ...
    public class Placement : MonoBehaviour
    {
        ...
        private UnityAction<Vector3, Quaternion> _callback;
        ...
        #region Events
        public event UnityAction<FitType> OnPlacementEvent;
        #endregion
        ...
        /// </summary>
        public void Place(Transform placementSource, Vector3 scale, bool allowHorizontal, bool allowVertical, UnityAction<Vector3, Quaternion> callback)
        {
            if (IsRunning) return;
